    ...
    public static function create_booking_rules_page(){
        ...
        <div class="wrap">
            ...
            <div id="confirm_del_rule" class="babe_overlay_inner">
              ...
              <h1>'.__('Delete selected rule?', 'ba-book-everything').'</h1>
            ...
            <?php
                ...
                submit_button(__('Add rule', 'ba-book-everything'));
            ?>
            </form>
        </div>
        <?php
    ...
    public static function booking_rules_page_init(){
        ...
        */
        ...
        add_settings_field(
            ...
            __('Stop booking .. hours before the start (applied to recurrent custom booking priod only)','ba-book-everything'), // Title
...
/////////////////////////////////////
    ...
    public static function callback_booking_mode(){
        ...
        <p><input id="babe_tmp_settings[booking_mode]4" name="babe_tmp_settings[booking_mode]" type="radio" value="request" /><label for="babe_tmp_settings[booking_mode]4">'.__('Request for price and details', 'ba-book-everything').'</label> <span class="babe_developement">'.__('(*in the development)', 'ba-book-everything').'</span></p>';
    }
/////////////////////////////////////
