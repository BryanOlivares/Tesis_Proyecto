...
///////////////////////////////////////
    ...
    public static function wp_enqueue_scripts() {
     ...
     wp_enqueue_script( 'babe-prices-js', plugins_url( "js/admin/babe-admin-prices.js", BABE_PLUGIN ), array('jquery'), BABE_VERSION, true );
     wp_localize_script( 'babe-prices-js', 'babe_prices_lst', array(
          ...
          wp_enqueue_style( 'babe-admin-prices-style', plugins_url( "css/admin/babe-admin-prices.css", BABE_PLUGIN ), array(), BABE_VERSION);
      }
...
///////////////////////////////////////
    ...
    public static function enqueued_assets() {
     ...
     wp_enqueue_script( 'babe-admin-prices-js', plugins_url( "js/admin/babe-admin-prices.js", BABE_PLUGIN ), array('jquery'), BABE_VERSION, true );
             ...
             if ( !empty($rules) ){
                ...
                <div class="rate_form_inner no_active">    
                    <div class="rate_title">
                        <label for="_rate_title">'.__('Title:', 'ba-book-everything').'</label>
                    ...
                    $output .= '
                        <button class="btn button button-secondary" id="add_price_conditional">'.__('Add conditional price', 'ba-book-everything').'</button>
                      </div>
                    ';
                    ...
                    <div class="rate-save-button">
                       <button class="btn button button-primary" id="add_price">'.__('Save rate', 'ba-book-everything').'</button><span class="spin_f no_active"><i class="fas fa-spinner fa-spin fa-2x"></i></span>
                    </div>
               </div>     
                    ';
...
//////////////////////////////
    ...
    $output['post_id'] = isset($_POST['post_id']) && $_POST['post_id'] ? (int)$_POST['post_id'] : 0;
