...
////////////////////////
    ...
    public static function send_admin_email_order_updated($order_id){
        ...
        self::send_email($email_to, esc_html(sprintf(BABE_Settings::$settings['email_admin_order_updated_subject'], BABE_Order::get_order_number($order_id))), $body);
...
////////////////////////
    ...
    public static function send_email_order_updated($order_id){
        ...
        if ($customer_details['email']){
            ...
            self::send_email($email_to, esc_html(sprintf(BABE_Settings::$settings['email_order_updated_subject'], BABE_Order::get_order_number($order_id))), $body, array(), $attachments);
        }
    }
