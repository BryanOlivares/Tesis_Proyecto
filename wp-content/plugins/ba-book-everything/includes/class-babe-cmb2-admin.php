     ...
     public static function cmb2_price_details($field, $value, $object_id, $object_type, $field_type){
      ...
      $output .= '<div id="babe_overlay_container">
            <div id="confirm_del_rate" class="babe_overlay_inner">
              ...
              <h1>'.__('Delete selected rate?', 'ba-book-everything').'</h1>
    ...
    public static function order_metabox() {
      ...
      $cmb->add_field( array(
        ...
        if ( empty( $cmb->object_id() ) ){
            ...
            $order_statuses = BABE_Order::$order_statuses;
        }
      ...
      $cmb->add_field( array(
         'name' => __( 'Total amount, ', 'ba-book-everything' ).BABE_Currency::get_currency_symbol(),
      ...
      $cmb->add_field( array(
         'name' => __( 'Expected Prepaid amount, ', 'ba-book-everything' ).BABE_Currency::get_currency_symbol(),
      ...
      $cmb->add_field( array(
         'name' => __( 'Prepaid received, ', 'ba-book-everything' ).BABE_Currency::get_currency_symbol(),
    ...
    $group_excluded_dates = $cmb->add_field( array(
                ...
                // 'description' => __( 'Slideshow Images', 'ba-book-everything' ),
                 ...
                 'options'     => array(
                   ...
                   'add_button'    => __( 'Add date to exclude from schedule', 'ba-book-everything' ),
...
///////////////////////////////////////
   ...
   // 'desc'       => __( 'field description (optional)', 'ba-book-everything' ),
    ...
    /*
    $cmb_term->add_field( array(
		'name'         => __( 'Enable Reviews?', 'ba-book-everything' ),
