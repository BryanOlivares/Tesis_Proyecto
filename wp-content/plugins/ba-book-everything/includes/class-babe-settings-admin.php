...
//////////////////////////////////////    
    ...
    public static function setting_google_map_active(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[google_map_active]1" name="'.BABE_Settings::$option_name.'[google_map_active]" type="radio" value="1" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_google_map_active1" for="'.BABE_Settings::$option_name.'[google_map_active]1">'.__('Yes', 'ba-book-everything').'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[google_map_active]2" name="'.BABE_Settings::$option_name.'[google_map_active]" type="radio" value="0" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_google_map_active2" for="'.BABE_Settings::$option_name.'[google_map_active]2">'.__('No', 'ba-book-everything').'</label></p>';
...
////////////mpoints_active///////////////////
    ...
    public static function setting_mpoints_active(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[mpoints_active]1" name="'.BABE_Settings::$option_name.'[mpoints_active]" type="radio" value="1" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_mpoints_active1" for="'.BABE_Settings::$option_name.'[mpoints_active]1">'.__('Yes', 'ba-book-everything').'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[mpoints_active]2" name="'.BABE_Settings::$option_name.'[mpoints_active]" type="radio" value="0" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_mpoints_active2" for="'.BABE_Settings::$option_name.'[mpoints_active]2">'.__('No', 'ba-book-everything').'</label></p>';
...
/////////////setting_view_only_uploaded_images
    ...
    public static function setting_view_only_uploaded_images(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[view_only_uploaded_images]1" name="'.BABE_Settings::$option_name.'[view_only_uploaded_images]" type="radio" value="1" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_view_only_uploaded_images1" for="'.BABE_Settings::$option_name.'[view_only_uploaded_images]1">'.__('Yes', 'ba-book-everything').'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[view_only_uploaded_images]2" name="'.BABE_Settings::$option_name.'[view_only_uploaded_images]" type="radio" value="0" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_view_only_uploaded_images2" for="'.BABE_Settings::$option_name.'[view_only_uploaded_images]2">'.__('No', 'ba-book-everything').'</label></p>';
...
/////////////setting_unitegallery_remove///////////////////////
     ...
     public static function setting_unitegallery_remove(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[unitegallery_remove]1" name="'.BABE_Settings::$option_name.'[unitegallery_remove]" type="radio" value="1" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_unitegallery_remove1" for="'.BABE_Settings::$option_name.'[unitegallery_remove]1">'.__('Yes', 'ba-book-everything').'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[unitegallery_remove]2" name="'.BABE_Settings::$option_name.'[unitegallery_remove]" type="radio" value="0" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_unitegallery_remove2" for="'.BABE_Settings::$option_name.'[unitegallery_remove]2">'.__('No', 'ba-book-everything').'</label></p>';
...
////////////av_calendar_remove//////////////////   
    ...
    public static function setting_av_calendar_remove(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[av_calendar_remove]1" name="'.BABE_Settings::$option_name.'[av_calendar_remove]" type="radio" value="1" '.$checked1.'/><label for="'.BABE_Settings::$option_name.'[av_calendar_remove]1">'.__('Yes', 'ba-book-everything').'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[av_calendar_remove]2" name="'.BABE_Settings::$option_name.'[av_calendar_remove]" type="radio" value="0" '.$checked2.'/><label for="'.BABE_Settings::$option_name.'[av_calendar_remove]2">'.__('No', 'ba-book-everything').'</label></p>';
...
/////////////setting_google_map_remove///////////////////////
     ...
     public static function setting_google_map_remove(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[google_map_remove]1" name="'.BABE_Settings::$option_name.'[google_map_remove]" type="radio" value="1" '.$checked1.'/><label for="'.BABE_Settings::$option_name.'[google_map_remove]1">'.__('Yes', 'ba-book-everything').'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[google_map_remove]2" name="'.BABE_Settings::$option_name.'[google_map_remove]" type="radio" value="0" '.$checked2.'/><label for="'.BABE_Settings::$option_name.'[google_map_remove]2">'.__('No', 'ba-book-everything').'</label></p>';
...
/////////////services_to_booking_form///////////////////////
     ...
     public static function setting_services_to_booking_form(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[services_to_booking_form]1" name="'.BABE_Settings::$option_name.'[services_to_booking_form]" type="radio" value="1" '.$checked1.'/><label for="'.BABE_Settings::$option_name.'[services_to_booking_form]1">'.__('Yes', 'ba-book-everything').'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[services_to_booking_form]2" name="'.BABE_Settings::$option_name.'[services_to_booking_form]" type="radio" value="0" '.$checked2.'/><label for="'.BABE_Settings::$option_name.'[services_to_booking_form]2">'.__('No', 'ba-book-everything').'</label></p>';
